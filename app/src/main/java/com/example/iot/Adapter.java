...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.detak.setText(String.valueOf(listHistory.get(position).getDetak()) + " BPM");
        holder.kbb.setText(String.valueOf(listHistory.get(position).getKbb()) + " %");
        holder.debu.setText(String.valueOf(listHistory.get(position).getDebu()) + " pq/m3");
